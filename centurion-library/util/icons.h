...
#define FONT_ICON_FILE_NAME_FA "icons_15"
...
static const char8_t* GetIconUTF8Reference(std::string name)
{
	if (name == "ICON_SEARCH")
		return u8"\uF002";
	if (name == "ICON_COG")
		return u8"\uF013";
	if (name == "ICON_DOWNLOAD")
		return u8"\uF019";
	if (name == "ICON_LOAD")
		return u8"\uF021";
	if (name == "ICON_PENCIL")
		return u8"\uF040";
	if (name == "ICON_QUESTION_MARK")
		return u8"\uF059";
	if (name == "ICON_EXCLAMATION_TRIANGLE")
		return u8"\uF071";
	if (name == "ICON_BALLOON")
		return u8"\uF075";
	if (name == "ICON_UPLOAD")
		return u8"\uF093";
	if (name == "ICON_FOLDER")
		return u8"\uF07B";
	if (name == "ICON_FOLDER_OPENED")
		return u8"\uF07C";
	if (name == "ICON_WRENCH")
		return u8"\uF0AD";
	if (name == "ICON_PLAYERS")
		return u8"\uF0C0";
	if (name == "ICON_FLOPPY")
		return u8"\uF0C7";
	if (name == "ICON_TEXT")
		return u8"\uF0F6";
	if (name == "ICON_PORTFOLIO")
		return u8"\uF114";
	if (name == "ICON_PORTFOLIO_OPENED")
		return u8"\uF115";
	if (name == "ICON_APP")
		return u8"\uF116";
	...
	if (name == "ICON_NOTE")
		return u8"\uF24A";
	if (name == "ICON_DIPLOMACY")
		return u8"\uF2B5";
	if (name == "ICON_WINDOW_MAXIMIZE")
		return u8"\uF2D0";
	if (name == "ICON_EMPTY_FRAME")
		return u8"\u00A8";
	return u8"\u00A8";
}